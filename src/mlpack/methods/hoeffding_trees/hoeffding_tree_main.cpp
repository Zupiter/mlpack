...
static void mlpackMain()
{
  ...
  if (IO::HasParam("training"))
  {
    ...
    if (IO::HasParam("test"))
    {
        ...
        CheckInputShape("hoeffding_tree", trainingSet.n_rows, trainingSet.n_cols, 1, labels.n_elem,  testPoints.n_rows, testPoints.n_cols);
    }
    else
      CheckInputShape("hoeffding_tree", trainingSet.n_rows, trainingSet.n_cols, 1, labels.n_elem, -1, -1);
