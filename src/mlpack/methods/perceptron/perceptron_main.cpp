...
static void mlpackMain()
{
  ...
  if (IO::HasParam("training"))
  {
    ...
    if (IO::HasParam("test"))
    {
        ...
        CheckInputShape("perceptron", trainingData.n_rows, trainingData.n_cols, 1, labels.n_elem,  testPoints.n_rows, testPoints.n_cols);
    }
    else
      CheckInputShape("perceptron", trainingData.n_rows, trainingData.n_cols, 1, labels.n_elem, -1, -1);
