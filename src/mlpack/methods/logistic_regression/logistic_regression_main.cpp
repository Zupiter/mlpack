...
static void mlpackMain()
{
  ...
  if(IO::HasParam("training"))
  {
    if (IO::HasParam("test"))
    {
        ...
        CheckInputShape("logistic_regreesion", regressors.n_rows, regressors.n_cols, 1, responses.n_elem,  testPoints.n_rows, testPoints.n_cols);
    }
    else
      CheckInputShape("logistic_regression", regressors.n_rows, regressors.n_cols, 1, responses.n_elem, -1, -1);
  }
  // Now, do the training.
  if (IO::HasParam("training"))
  {
